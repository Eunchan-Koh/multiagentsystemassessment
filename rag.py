...
def insert_pdf(token_size=200, pdf_path: str = None) -> None:
...
def retrieve_similar_content(user_input, top_k=10, threshold=0.65) -> list:
    """_summary_
...
# runs it only once to initialize the table for RAG. after that, it can be commented out.
